class TriviaApi {
  constructor(){
    const BASE_URL = 'https://opentdb.com/api.php?amount=5&category=20&difficulty=easy&type=multiple';

    const TriviaApiFetch = function(...args) {
  ...
  getQuestions(){
    ...
    return TriviaApi.TriviaApiFetch();
